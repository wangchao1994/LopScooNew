...
public class StringUtils {
    ...
    public static String getRatingColorString(String vote) {
        StringBuffer sb = new StringBuffer();
        if (vote == null || vote.equals("") || !StringUtils.isFloat(vote)) {
            vote = "0";
        }
    ...
    public static String getBpSetRetryUrl(String retryName, String sourceStr) {
        String retryUrl = StringUtils.replaceRealmName(retryName,
    ...
    public static String getBpPlayRetryUrl(String retryName, String sourceStr) {
        String retryUrl = StringUtils.replaceRealmName(retryName, "dp.ugc.pps.tv",
                sourceStr);
        return retryUrl;
    }
